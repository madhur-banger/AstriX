...
const LandingPage = () => {
  ...
  // The orb is the only consumer of the pointer position, so it is written
  // straight to the node once per animation frame. Putting it in React state
  // re-rendered this entire page on every raw mousemove event.
  useEffect(() => {
    let frame = 0;
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      frame = requestAnimationFrame(() => {
        ...
        orbRef.current.style.transform = `translate3d(${
          event.clientX - ORB_RADIUS
        }px, ${event.clientY - ORB_RADIUS}px, 0)`;
      });
    };
  ...
  const features = [
    {
      ...
      description:
        "Every task carries a status, priority, assignee and due date - and the whole workspace is searchable and filterable",
    },
    {
      icon: Users,
      title: "Shared workspaces",
      description:
        "Invite your team with a single link and keep separate teams, clients or products in their own workspace",
    },
    {
      icon: BarChart3,
      title: "Project analytics",
      description:
        "Total, completed and overdue tasks for every project and for the workspace as a whole, kept up to date automatically",
    },
    {
      icon: Zap,
      title: "Fast by default",
      description:
        "Cached queries and paginated tables keep the interface responsive as your backlog grows",
    },
    {
      icon: Calendar,
      title: "Deadlines you can see",
      description:
        "Due dates are part of every task, so overdue work surfaces in analytics instead of getting lost in a thread",
    },
    {
      icon: GitBranch,
      title: "Projects that stay organised",
      description:
        "Group related work into projects, each with its own task table and analytics",
    },
  ];

  // Product principles, not customer quotes. Real testimonials and adoption
  // metrics belong here once there are customers to quote and numbers to cite.
  const principles = [
    {
      icon: Target,
      title: "One place for the work",
      description:
        "Projects, owners, priorities and due dates live in the same workspace, so nobody has to reconstruct status from chat history.",
    },
    {
      icon: Shield,
      title: "Access you actually control",
      description:
        "Roles decide who can invite members, edit projects and delete work, and those checks are enforced on the server - not just hidden in the UI.",
    },
    {
      icon: Activity,
      title: "Progress you can measure",
      description:
        "Completed, in-flight and overdue work is counted for you, so a status update doesn't need a spreadsheet in the middle.",
    },
  ];
  ...
  const highlights = [
    {
      ...
      description: "Keep teams, clients or products apart",
    },
    {
      icon: Users,
      title: "Invite by link",
      description: "Share one link; roles decide the rest",
    },
    {
      icon: CheckCircle2,
      title: "Filterable task table",
      description: "By status, priority, assignee or project",
    },
    {
      icon: TrendingUp,
      title: "Built-in analytics",
      description: "Completed and overdue, per project",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-[#0a0a0a] dark:via-[#111111] dark:to-[#0a0a0a] overflow-hidden">
      ...
      <div
        ref={orbRef}
        className="fixed left-0 top-0 w-[800px] h-[800px] rounded-full opacity-30 blur-3xl pointer-events-none transition-transform duration-500"
        style={{
          background:
            "radial-gradient(circle, rgba(0,0,0,0.4) 0%, transparent 70%)",
          transform: `translate3d(${-ORB_RADIUS}px, ${-ORB_RADIUS}px, 0)`,
        }}
      />
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-200 dark:bg-gray-800 mb-8 animate-fade-in-left">
              ...
              <span className="text-sm font-medium">
                Plan, track and ship in one workspace
              </span>
            </div>

            <h1
              className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 animate-fade-in-left gradient-text"
            ...
            <p
              className="text-xl text-gray-600 dark:text-gray-400 mb-10 animate-fade-in-left"
              style={{ animationDelay: "0.2s" }}
            >
              The all-in-one workspace for teams to plan, track, and deliver
              projects with unprecedented clarity and speed.
            </p>

            <div
              className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-in-left"
            ...
            <div
              className="grid grid-cols-2 gap-6 animate-fade-in-left"
              style={{ animationDelay: "0.4s" }}
            >
              {highlights.slice(0, 2).map((highlight, i) => (
                <div key={i} className="flex items-center gap-3">
                  <div className="w-12 h-12 shrink-0 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg flex items-center justify-center">
          ...
          <div className="relative productivity-graph">
            ...
            <div
              className="absolute -left-8 top-1/4 animate-scale-in"
              style={{
                animationDelay: "0.6s",
            ...
            <div
              className="absolute -right-8 top-1/3 animate-scale-in"
              style={{
                animationDelay: "0.8s",
            ...
            <div
              className="absolute left-1/4 -bottom-4 animate-scale-in"
              style={{
                animationDelay: "1s",
            ...
            <div
              className="absolute right-1/4 -top-4 animate-scale-in"
              style={{
                animationDelay: "0.7s",
            ...
            {/* Main Graph Card */}
            <div
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-200 dark:border-gray-800 animate-scale-in"
      ...
      >
        <div
          className={`text-center mb-12 ${inView["capabilities"] ? "animate-fade-in-up" : "opacity-0"}`}
        >
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-center">
            {capabilities.map((capability, i) => (
              <div
                key={i}
                className={`flex flex-col items-center gap-2 ${inView["capabilities"] ? "animate-fade-in-up" : "opacity-0"}`}
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center">
                  <capability.icon className="w-8 h-8 text-gray-600 dark:text-gray-400" />
                </div>
      ...
      >
        <div
          className={`text-center mb-16 ${inView["features"] ? "animate-fade-in-up" : "opacity-0"}`}
        >
          <h2 className="text-4xl sm:text-5xl font-bold mb-4">
            Everything you need
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Powerful features designed to help your team collaborate and deliver
            faster
          </p>
        </div>
      ...
      >
        <div
          className={`text-center mb-16 ${inView["principles"] ? "animate-fade-in-up" : "opacity-0"}`}
        >
          <h2 className="text-4xl sm:text-5xl font-bold mb-4">
            Built for teams who value clarity
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            The ideas the product is built around
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {principles.map((principle, i) => (
            <div
              key={i}
              className={`card-hover bg-white dark:bg-gray-900 p-8 rounded-2xl border border-gray-200 dark:border-gray-800 ${inView["principles"] ? "animate-slide-in-up" : "opacity-0"}`}
              style={{ animationDelay: `${i * 0.15}s` }}
            >
              <div className="w-12 h-12 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-xl flex items-center justify-center mb-6">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-3xl p-12 sm:p-16 border border-gray-200 dark:border-gray-800">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
            {highlights.map((highlight, i) => (
              <div
                key={i}
                className={`text-center ${inView["highlights"] ? "animate-scale-in" : "opacity-0"}`}
                style={{ animationDelay: `${i * 0.1}s` }}
              >
      ...
      >
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Task Analytics */}
          <div
            className={`${inView["showcase"] ? "animate-fade-in-left" : "opacity-0"}`}
          >
            <div className="mb-8">
              <h3 className="text-3xl font-bold mb-4">Analytics built in</h3>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                See what your team has completed, what is still in flight and
                what is overdue - per project and across the workspace. The
                screens below are interface previews filled with sample data.
              </p>
            </div>
                  ...
                  >
                    ...
                    <div className="w-full h-3 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: inView["showcase"] ? `${item.value}%` : "0%",
                        }}
                      />
                    </div>
                  </div>
          ...
          <div
            className={`${inView["showcase"] ? "animate-fade-in-right" : "opacity-0"}`}
          >
      ...
      >
        <div
          className={`bg-gradient-to-br from-black to-gray-800 dark:from-white dark:to-gray-200 rounded-3xl p-12 sm:p-16 text-center text-white dark:text-black relative overflow-hidden ${inView["cta"] ? "animate-scale-in" : "opacity-0"}`}
        >
          ...
          <div
            className="absolute top-1/2 right-16 opacity-20"
            style={{
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl opacity-90 mb-10 max-w-2xl mx-auto">
              Bring your projects, tasks and team into one workspace, and keep
              everyone looking at the same plan.
            </p>
            <Button
              size="lg"
              variant="secondary"
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-6 py-12 border-t border-gray-200 dark:border-gray-800">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          {/* TODO: add a Contact link once there is a real support address or
              contact route to point it at - it used to be a dead "#" link. */}
